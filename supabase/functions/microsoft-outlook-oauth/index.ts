  ...
  try {
    if (method === 'GET') {
      ...
      return new Response(`
        ...
        <html>
        <head>
          <title>Microsoft Outlook Connected</title>
          <style>
        ...
        <body>
          <h1 class="success">✅ Microsoft Outlook Connected Successfully!</h1>
    ...
    if (method === 'POST') {
      ...
      authUrl.searchParams.set('redirect_uri', `${Deno.env.get('SUPABASE_URL')}/functions/v1/microsoft-outlook-oauth`);
