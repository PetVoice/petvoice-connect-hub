-- Fix della funzione RPC - problema con nome variabile ambiguo
...
DECLARE
  ...
  result_data jsonb;
  user_id_found UUID;  -- Cambio nome per evitare ambiguità
BEGIN
  ...
  SET 
    ...
    referred_user_id = user_id_found, -- Usa nome non ambiguo
    updated_at = now()
  ...
  INSERT INTO public.activity_log (
    ...
    jsonb_build_object(
      ...
      'referred_user_id', user_id_found,
