...
-- Inserisci tutti i 30 esercizi (3 per ogni giorno) usando solo exercise_type "behavioral"
...
(
    ...
    10,
    ARRAY[
        'Posiziona 6 oggetti in linea distanti 1 metro uno dall altro',
...
(
    ...
    'Gestione della eccitazione in situazioni trigger come la uscita',
    'behavioral',
    10,
    ARRAY[
...
(
    ...
    'Interruzione immediata della attività su comando per sviluppare autocontrollo',
    'behavioral',
    8,
    ARRAY[
...
(
    ...
    ARRAY[
        ...
        'Usa diversi tipi di premi per generalizzare la esercizio',
...
(
    ...
    'Gestione della impulso a tirare e mantenimento andatura controllata',
    'behavioral',
    10,
    ARRAY[
...
(
    ...
    'Gestione della iperattività in presenza di persone nuove',
    'behavioral',
    10,
    ARRAY[
        ...
        'Aumenta gradualmente durata della interazione'
    ],
...
(
    ...
    ARRAY[
        ...
        'Varia la ordine per mantenere attenzione alta',
