-- Verifica prima se devo rimuovere la constraint NOT NULL per user_id
-- per permettere protocolli pubblici di sistema

-- Temporaneamente rendo user_id nullable per i protocolli di sistema
ALTER TABLE ai_training_protocols ALTER COLUMN user_id DROP NOT NULL;
...
-- (protocolli di sistema senza user_id specifico ma pubblici)
