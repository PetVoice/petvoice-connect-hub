...
SET instructions = CASE 
  ...
  WHEN title = 'Zona Sicura' THEN ARRAY[
    ...
    '2. BASE COMFORT: Stendi una coperta di pile o cotone morbido (almeno 80x80cm), aggiungi un cuscino che abbia il profumo di casa. Controlla che non ci siano correnti d\'aria.',
  ...
  WHEN title = 'Massaggio Rilassante' THEN ARRAY[
    ...
    '4. COLLO E SPALLE: Usa tutta la mano per carezze lunghe dal collo alle spalle, sempre dall\'alto verso il basso. Pressione media, come spalmarea crema.',
  ...
  WHEN title = 'Desensibilizzazione Graduale' THEN ARRAY[
    ...
    '5. GESTIONE STRESS: Se noti segni di stress (ansimare, tremare, nascondersi), fermati immediatamente e torna alla distanza/intensità precedente.',
  ...
  WHEN title = 'Gioco Interattivo Calmo' THEN ARRAY[
    '1. PREPARAZIONE PUZZLE: Usa giochi tipo Kong o tappetini sniffing, riempili con cibo umido o crocchette mischiate a un po\' di formaggio spalmabile.',
