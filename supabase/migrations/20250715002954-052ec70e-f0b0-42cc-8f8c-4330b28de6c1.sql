-- PULIZIA COMPLETA CON CASCADE: Rimuove TUTTI i trigger e funzioni referral esistenti
...
DROP TRIGGER IF EXISTS on_auth_user_created_no_subscription ON auth.users;

-- Rimuove tutte le funzioni referral esistenti con CASCADE
DROP FUNCTION IF EXISTS public.handle_referral_payment() CASCADE;
DROP FUNCTION IF EXISTS public.handle_referral_conversion() CASCADE;
...
DROP FUNCTION IF EXISTS public.handle_new_user_no_subscription() CASCADE;
