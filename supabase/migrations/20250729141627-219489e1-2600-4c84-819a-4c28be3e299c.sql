-- Database Analysis and Cleanup Migration (Fixed)
...
CREATE INDEX IF NOT EXISTS idx_diary_entries_user_entry_date 
ON public.diary_entries(user_id, entry_date DESC);

CREATE INDEX IF NOT EXISTS idx_pet_analyses_user_created 
