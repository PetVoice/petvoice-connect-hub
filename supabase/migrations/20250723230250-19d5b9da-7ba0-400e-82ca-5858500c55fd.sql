...
CROSS JOIN (VALUES
  ...
  -- Giorno 4
  (4, 'Gestione Frustrazione', 'Strategie per gestire quando le cose non vanno come vuole', 35, ARRAY['Presenta sfide gestibili', 'Insegna a gestire fallimento', 'Premia tentativi anche se falliti', 'Mostra alternative quando bloccato'], ARRAY['Sfide graduate', 'Piani B sempre pronti']),
  ...
  -- Giorno 7
  (7, 'Autonomia di Autoregolazione', 'Sviluppo indipendenza nel controllo', 30, ARRAY['Riduci supporto esterno gradualmente', 'Lascia gestire situazioni da solo', 'Intervieni solo in emergenza', 'Premia autogestione'], ARRAY['Autonomia guidata', 'Osservazione discreta']),
