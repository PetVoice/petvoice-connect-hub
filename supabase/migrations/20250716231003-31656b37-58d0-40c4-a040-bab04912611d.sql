-- FIX: Calcola commissione dinamica basata sul tier del referrer
...
BEGIN
  ...
  RETURN jsonb_build_object('converted_count', converted, 'message', 'Converted ' || converted || ' referrals with dynamic commission');
END;
$function$;