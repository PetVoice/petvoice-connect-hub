-- Aggiorna la funzione per calcolare commissioni dinamiche basate sul tier
  ...
  IF ref_code IS NOT NULL AND ref_code != '' THEN
    ...
    IF referrer_user_id IS NOT NULL THEN
      ...
      INSERT INTO public.referral_credits (
        ...
        credit_amount,
        'referral_conversion',
        'Credito per conversione referral: ' || NEW.email || ' (tier ' || current_tier || ' ' || (tier_commission * 100)::INTEGER || '%)',
        'active',
