-- Prima cancella TUTTE le policy esistenti
...
-- Ricrea le policy corrette per support_tickets
...
-- Ora le policy per support_ticket_replies
...
DROP POLICY IF EXISTS "Users can view replies for own tickets" ON support_ticket_replies;
DROP POLICY IF EXISTS "Admins can view all ticket replies" ON support_ticket_replies;
DROP POLICY IF EXISTS "Users can create replies for own tickets" ON support_ticket_replies;
DROP POLICY IF EXISTS "Admins can create replies for all tickets" ON support_ticket_replies;
DROP POLICY IF EXISTS "Users can update own replies" ON support_ticket_replies;
DROP POLICY IF EXISTS "Admins can update all replies" ON support_ticket_replies;
