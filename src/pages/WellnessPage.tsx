...
const UnifiedHealthChart = ({ healthMetrics, diaryEntries, analyses, selectedPet }: {
  ...
  const getStatusColor = (value: number, type: string) => {
    if (type === 'temperature' && value > 0) return 'hsl(var(--destructive))';
    if (type === 'wellness' && value < 50) return 'hsl(var(--warning))';
    if (type === 'mood' && value < 40) return 'hsl(var(--destructive))';
