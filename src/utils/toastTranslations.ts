...
const toastTranslations = {
  it: {
    ...
    'pets.petUpdated.description': 'Le informazioni di {petName} sono state aggiornate',
    'pets.petDeleted.title': 'Pet eliminato',
    'pets.petDeleted.description': '{petName} è stato eliminato con successo',
  ...
  en: {
    ...
    'pets.petUpdated.description': '{petName} information has been updated',
    'pets.petDeleted.title': 'Pet deleted',
    'pets.petDeleted.description': '{petName} has been successfully deleted',
  ...
  es: {
    ...
    'pets.petUpdated.description': 'La información de {petName} ha sido actualizada',
    'pets.petDeleted.title': 'Mascota eliminada',
    'pets.petDeleted.description': '{petName} ha sido eliminada exitosamente',
